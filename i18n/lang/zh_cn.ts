export default {
    ...
    home: {
        ...
        features: {
            title: '功能特性',
            description: '基于DeepSeek OCR大模型的OCR文档识别工具网站功能特性',
            sutTitle_1: 'DeepSeek OCR识别引擎',
            subDescription_1: '基于30亿参数大模型和动态分块视觉编码技术，文本识别准确率超过95%',
            sutTitle_2: '多格式文档支持',
            subDescription_2: '支持PDF、JPEG、PNG、TIFF、BMP等多种格式文档的高精度识别',
            sutTitle_3: '多语言文本识别',
            subDescription_3: '支持中文、英文、日文、韩文等多种语言的准确识别',
            sutTitle_4: 'API接口集成',
            subDescription_4: '提供完整的RESTful API接口，方便与现有系统集成',
            sutTitle_5: '批量处理能力',
            subDescription_5: '支持批量文档处理，大幅提升工作效率',
            sutTitle_6: '安全可靠',
            subDescription_6: '文档处理过程加密传输，处理完成后立即删除，确保数据安全',
        },
        pricing: {
            title: '价格方案',
