    ...
    <div class="max-w-7xl mx-auto px-4">
      <div class="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
        ...
        <div class="col-span-2 md:col-span-1">
          <NuxtLink to="/" class="flex items-center mb-4 text-gray-900 text-xl font-semibold">
            <Logo />
          </NuxtLink>
          <a href="https://Ocr Processing.com" target="_blank" class="inline-flex items-center text-xs bg-white/60 hover:bg-white/80 text-gray-800 px-2 py-1 rounded">
            Built with 🚀 Ocr Processing
          </a>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><a href="https://Ocr Processing.com" target="_blank" rel="dofollow" class="hover:text-black">Ocr Processing</a></li>
      ...
      <div class="flex flex-col sm:flex-row justify-between items-center text-gray-600 text-sm">
        <div class="mb-4 sm:mb-0">
          &copy; {{ currentYear }} Ocr Processing All Rights Reserved.
        </div>
        <div class="flex space-x-4">
          <a href="https://github.com/PennyJoly/Ocr Processing" target="_blank" class="hover:text-black" aria-label="GitHub">
